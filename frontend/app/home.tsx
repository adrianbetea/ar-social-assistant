...
export default function HomeScreen() {
  ...
  const [aiStatus, setAiStatus] = useState<'online' | 'limited' | 'offline'>('offline');
    ...
    return [
      {
        ...
        status: cameraGranted ? 'Camera permissions granted' : 'Camera permissions not granted',
        detail: cameraGranted ? 'Camera permission granted' : 'Camera permission required',
      },
      {
        label: 'Microphone Permissions',
        status: micGranted ? 'Microphone permissions on' : 'Microphone permissions off',
        detail: micGranted ? 'Microphone permission granted' : 'Microphone permission required',
      },
      { label: 'Wingman AI', status: wingmanStatus, detail: wingmanDetail },
    ];
  }, [aiStatus, cameraPermission?.granted, micPermission?.granted]);
        ...
        <View style={styles.actionCard}>
          ...
          <View style={styles.secondaryRow}>
            <Pressable
              ...
              <NeonText style={styles.secondaryButtonLabel}>Recent Logs</NeonText>
            </Pressable>
            <Pressable
              style={({ pressed }) => [styles.secondaryButton, pressed && styles.secondaryButtonPressed]}
              onPress={() => router.push('/profile')}>
              <NeonText style={styles.secondaryButtonLabel}>Profile Settings</NeonText>
            </Pressable>
          </View>
        </View>
...
const styles = StyleSheet.create({
  ...
  secondaryButton: {
    ...
    backgroundColor: 'rgba(8, 24, 36, 0.8)',
    flexGrow: 1,
    flexBasis: '48%',
  },
